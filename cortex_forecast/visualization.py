...
def plot_storage_forecast(forecast_data, actual_data):
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=forecast_data['FORECAST_DATE'], y=forecast_data['FORECAST'], mode='lines', name='Forecast'))
    fig.add_trace(go.Scatter(x=forecast_data['FORECAST_DATE'], y=forecast_data['LOWER_BOUND'], mode='lines', name='Upper Bound', line=dict(dash='dash')))
    fig.add_trace(go.Scatter(x=forecast_data['FORECAST_DATE'], y=forecast_data['UPPER_BOUND'], mode='lines', name='Lower Bound', line=dict(dash='dash')))
